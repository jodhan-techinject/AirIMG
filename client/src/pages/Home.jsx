...
const Home = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-primary-100 font-bebas text-6xl">
          The Community Showcase
        </h1>
        <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px] font-poppins">
          Browse through a collection of generated by community
        </p>
      </div>
