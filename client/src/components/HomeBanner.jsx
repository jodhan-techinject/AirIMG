        ...
        <div className="relative">
            ...
            <div className="relative mx-auto max-w-7xl px-4 py-14 md:py-20 sm:px-6 lg:px-8">
                <div className="flex flex-col items-center text-center">
                    ...
                    {/* Main heading */}
                    <h1 className="mb-6 font-poppins text-4xl md:text-6xl font-bold tracking-wider text-white sm:text-7xl">
                        THE COMMUNITY
                        <br />
                        SHOWCASE
                    </h1>
                    ...
                    {/* Subtitle */}
                    <p className="mb-8 max-w-2xl text:md md:text-lg text-gray-400 font-poppins">
